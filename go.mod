...
require (
	...
	github.com/heimweh/go-pagerduty v0.0.0-20230404180624-b51b4562bcba
...
replace github.com/heimweh/go-pagerduty => github.com/alenapan/go-pagerduty v0.0.0-20230322200217-d68066c0b414
